---
layout: default
title: Expectations and Procedures
---
...
### Logging time in Workday

- Timesheets are processed through [Workday](http://workday.brynmawr.edu/) and will be due every other Wednesday, starting May 27 (see [Student Payroll Schedule](https://www.brynmawr.edu/inside/offices-services/finance-administration/payroll/student-employees/student-payroll-schedule)).
- Your Digital Scholarship position will appear under the “supervisory organization” Educational and Scholarly Technology_STU  (Alice McGrath). If you have multiple jobs, you will have to select this one from the drop-down menu in order to enter time.
- See these Workday guides and how-tos for instructions:
  - [Entering time worked](https://www.brynmawr.edu/sites/default/files/media/documents/2025-11/EnterTimeWorked.pdf)
  - [Revising time worked](https://www.brynmawr.edu/sites/default/files/media/documents/2025-11/ReviseTimeWorked.pdf)
  - [Workday Essentials for Student Employees video](https://brynmawr.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=9b05866a-a744-4bba-baa6-b3a800e838ca)